...
\begin{DoxyCompactList}\small\item\em callback function of odometry \end{DoxyCompactList}\item 
...
\begin{DoxyParams}{Parameters}
{\em msg} & of odometry(\+Odometry)\+:the new odometry message \\
\hline
\end{DoxyParams}
...
{\em angle(angle)} & normalized angle \\
\hline
\end{DoxyRetVals}
