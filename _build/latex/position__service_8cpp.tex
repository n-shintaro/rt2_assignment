...
This files creates a service server to create the random position.  
...
\begin{DoxyCompactList}\small\item\em generate the random number \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em callback function\+: generate the random position \end{DoxyCompactList}\item 
int \mbox{\hyperlink{position__service_8cpp_a3c04138a5bfe5d72780bb7e82a18e627}{main}} (int argc, char $\ast$$\ast$argv)
\begin{DoxyCompactList}\small\item\em server (/position\+\_\+server) which generates the random x,y,theta \end{DoxyCompactList}\end{DoxyCompactItemize}
...
This node define the position server. When the service is requested, my random function generates the random position between the max and the min. 
...
server (/position\+\_\+server) which generates the random x,y,theta 
...
callback function\+: generate the random position 


\begin{DoxyParams}{Parameters}
{\em req} & (rt2\+\_\+assignment1\+::\+Random\+Position\+::\+Request)\+: request of max and min number \\
\hline
{\em res(rt2\+\_\+assignment1\+::\+Random\+Position\+::\+Response)} & response \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em M} & (double)\+: the upper bound \\
\hline
{\em N} & (double)\+: the lower bound\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
radom number\+: between M and N 
\end{DoxyReturn}
